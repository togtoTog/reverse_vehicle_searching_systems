...
class_names = ['yellow', 'black', 'orange', 'green', 'gray', 'red', 'blue', 'white', 'golden',
               'brown']  # 这个顺序很重要，要和训练时候的类名顺序一致
# 真实的顺序
class_names_real = ['yellow', 'orange', 'green', 'gray', 'red', 'blue', 'white', 'golden',
                    'brown', 'black']  # 这个顺序很重要，要和训练时候的类名顺序一致
...
cnt_under_thres = 0
cnt_all = 0
logzero.logfile('./classification.log')
...
if __name__ == '__main__':
    ...
    image_dir = color_cfg.TEST.DATASET
    start_time = time.time()
